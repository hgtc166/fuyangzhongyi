...
## v3.3.1 — 2026-08-31 · 全站合规修复（医疗前置审批已取消 + 两条红线）✅
- **背景（用户明确）**：医疗前置审批已取消——原《互联网医疗保健信息服务管理办法》（卫生部令第 66 号）依《国务院关于第一批取消 62 项中央指定地方实施行政审批事项的决定》（国发〔2015〕57 号）取消，该规章已于 2016-01-19 废止。官网可做科普、机构与专家展示，但须严守两条红线：① 禁止在线诊疗/开方；② 医疗/药品广告须审查、不得宣传疗效、不得夸大。
- **红线一（不提供在线诊断/不开具处方）**：删除 `specialty-detail.html` 顶部与 CTA 的「在线咨询」按钮及其 `data-consult` 处理链；首页小程序二维码 caption「线上问诊」→「预约到馆」；预约表单（specialty-detail）明确改写为「预约到馆面诊」，弹窗内加注「本表单仅用于预约到馆面诊，不构成在线诊断或开具处方；具体诊疗与处方须由执业医师在持有《医疗机构执业许可证》的实体机构内当面四诊合参后确定」。
- **统一免责声明（全 6 个已发布页面）**：首页 / 三专病概述页 / 代谢详情页 / 专病设计页 页脚均改写为统一合规声明——明确「不构成诊断与治疗建议，不提供在线诊断、不开具处方」「诊疗与处方须由执业医师在实体机构内当面四诊合参后确定」「如涉及医疗服务或药品广告将依法经广告审查取得批准文号，不宣传疗效、不作夸大或绝对化承诺」，并载明医疗前置审批已取消之事实与文号。
- **红线二（不宣传疗效/不作夸大）**：全站检索「治愈/根治/百分百/包治/神效/特效/断根」等绝对化疗效词——已发布 HTML 中仅 metabolism-clinic 一处「尚无特效药获批」（属否定性事实陈述，非疗效承诺），无违规疗效宣称；首页 meta description「一人一方」→「辨证论治」以弱化处方暗示；专病弹窗注脚补「不提供在线诊断与开方」。
- **未触碰**：站点保持纯科普/展示定位，未新增任何在线诊疗、开方或远程处方功能；`versions/`（历史快照，已 gitignore）中旧「预约问诊」文案不对外发布。
